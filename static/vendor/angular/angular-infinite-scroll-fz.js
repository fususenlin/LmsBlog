        ...
        return {
            ...
            link: function (scope, elem, attrs) {
                ...
                handler = function () {
                    ...
                    if (container === $window) {
                        containerBottom = container[0].innerHeight + container[0].pageYOffset;
                        elementBottom = elem[0].offsetTop + elem[0].clientHeight;
                    } else {
                        containerBottom = container[0].innerHeight;
                        elementBottom = elem[0].clientHeight - container[0].pageYOffset + elem[0].clientHeight;
                    }
