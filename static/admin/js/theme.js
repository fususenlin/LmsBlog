...
// skin changer
$("http://detail.herokuapp.com/js/.skins-nav .skin").click(function (e) {
    e.preventDefault();
    if ($(this).hasClass("selected")) {
        return;
    }
    $("http://detail.herokuapp.com/js/.skins-nav .skin").removeClass("selected");
...
$(window).resize(function () {
    $(this).width() > 769 && $("http://detail.herokuapp.com/js/body.menu").removeClass("menu")
})
...
var uiDropdown = new function () {
    ...
    return this.initialize = function () {
        $("html").click(function () {
            $("http://detail.herokuapp.com/js/.ui-dropdown .head").removeClass("active");
            return self.hideDialog($(".ui-dropdown"));
        });
        $("http://detail.herokuapp.com/js/.ui-dropdown .body").click(function (e) {
